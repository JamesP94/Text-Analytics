...
I'm basically cool with the amount of writing, but this needs to be seriously cleaned up. Read the "page" in the Assignment section and you'll see some guidelines for submissions. 

Get rid of the big prints to the screen. Delete unnecessary cells. Put in enough comments that if you came back to this in two years you could adapt this for a different project. The code is fine, just polish it a bit. 

## Hope this is better!

Sorry for the messiness on the first commit John, hope this is much cleaner and more succinct for you to look over. Thanks!